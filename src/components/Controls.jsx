  ...
  return (
    <>
      <div className='w-full'>
        <div className='text-sm md:text-xl flex flex-col sm:flex-row items-center justify-center gap-2 md:gap-4 p-2 md:p-3 bg-green-800 rounded-lg border border-green-950'>
          <button
